...
cout << "Current rate: " << RISE_RATE_MM_PER_YEAR << " mm/year" << endl;
cout << string(50, '-') << endl;
...
// Display results
cout << "In " << YEAR_5 <<" years: "  << riseIn5Years << " mm higher" << endl;
cout << "In " << YEAR_7 <<" years: "  << riseIn7Years << " mm higher" << endl;
cout << "In " << YEAR_10 <<" years: "  << riseIn10Years << " mm higher" << endl;
